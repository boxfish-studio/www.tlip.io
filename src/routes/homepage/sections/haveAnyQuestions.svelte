...
<section class="px-10 md:px-32 py-20 bg-blue-300" {id}>
    <div class="flex text-white justify-between flex-col text-center lg:flex-row lg:text-left">
        <div class="max-w-2xl lg:mr-7">
            ...
            <div class="buttons w-full flex gap-x-7 mt-20">
        ...
        <div class="w-full lg:max-w-md flex relative object-scale-down items-center mt-20 lg:mt-0 justify-center">
            <img src="./assets/have-questions-outter.png" alt="" />
            <img src="./assets/have-questions-inner.png" alt="" class="absolute w-4/12 object-scale-down" />
        </div>
    </div>
</section>
